...
export default function OrderDetails() {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
        <p className="text-center text-gray-500 text-sm sm:text-base">Loading order details...</p>
      </div>
    );
  }
  ...
  if (!order) {
    return (
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
        <p className="text-center text-gray-500 text-sm sm:text-base">Order not found.</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 mt-2">
                <select
                  value={status}
                  onChange={(e) => setStatus(e.target.value)}
                  className="w-full sm:w-auto p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-sm sm:text-base"
                >
                  <option value="Pending">Pending</option>
                  <option value="Shipped">Shipped</option>
                  <option value="Delivered">Delivered</option>
                ...
                <button
                  onClick={handleStatusUpdate}
                  disabled={statusUpdating}
                  className="w-full sm:w-auto bg-green-600 text-white py-1 sm:py-2 px-3 sm:px-4 rounded-lg hover:bg-green-700 transition-colors disabled:bg-gray-400 text-sm sm:text-base"
                >
                  {statusUpdating ? "Updating..." : "Update Status"}
                </button>
              </div>
      ...
      {/* Order Items */}
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg mt-4 sm:mt-6">
        <h3 className="text-xl sm:text-2xl font-semibold text-gray-700 mb-3 sm:mb-4">
          Order Items
        </h3>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm sm:text-base">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="p-2 sm:p-3 text-left text-gray-700">Product</th>
                <th className="p-2 sm:p-3 text-left text-gray-700 hidden sm:table-cell">Price</th>
                <th className="p-2 sm:p-3 text-left text-gray-700 hidden md:table-cell">Quantity</th>
                <th className="p-2 sm:p-3 text-left text-gray-700">Subtotal</th>
              </tr>
            </thead>
            <tbody>
              {order.items.map((item, index) => (
                <tr key={index} className="border-b hover:bg-gray-100 flex flex-col sm:table-row">
                  ...
                  <td className="p-2 sm:p-3 md:table-cell hidden">
