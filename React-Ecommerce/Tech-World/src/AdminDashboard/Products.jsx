            ...
            <table className="w-full border-collapse text-sm sm:text-base">
              <thead>
                <tr className="bg-gray-200">
                  ...
                  <th className="p-2 sm:p-3 text-left text-gray-700 hidden lg:table-cell">Created At</th>
                  <th className="p-2 sm:p-3 text-left text-gray-700">Actions</th>
                </tr>
              </thead>
              <tbody>
                {filteredProducts.map((product) => (
                  <tr key={product.id} className="border-b hover:bg-gray-100 flex flex-col sm:table-row">
                    ...
                    <td className="p-2 sm:p-3 block lg:table-cell">
                      <span className="lg:hidden font-semibold">Created At: </span>
